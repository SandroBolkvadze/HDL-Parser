...
- **Parsing and Building** (`engine` directory): `ChipParser` parses `.hdl` file `ChipDescription`. `ChipBuilder` utilizes `ChipParser` and `Loader` to build recursive representation of chip given its name.  
